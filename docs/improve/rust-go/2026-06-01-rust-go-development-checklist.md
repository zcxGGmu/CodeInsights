...
> 最新已确认恢复入口：`3089b768 docs(rust-go): 回填 Phase 5 最新状态和启动提示词`；若本轮状态回填再次提交后，下次启动以 `git log -5 --oneline` 中最新的 Rust / Go docs 提交为实际恢复入口。
