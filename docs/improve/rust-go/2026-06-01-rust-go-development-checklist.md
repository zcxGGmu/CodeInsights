...
> 最新已确认恢复入口：`6525f6fb docs(rust-go): 回填 Phase 5 publication invocation 最新恢复入口`；若本轮状态同步提交后，下次启动以 `git log -5 --oneline` 中最新的 Rust / Go docs 提交为实际恢复入口。
